            ...
            <div className="container-fluid">
                <Link to="/" className="navbar-brand">
                    <svg width="70" height="70" viewBox="0 0 132 103" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M62.1444 47.2949C61.1005 42.0753 48.8345 30.5923 34 36.1381" stroke="#000" stroke-width="2" />
                        <path d="M73.6611 45.0388C72.0045 36.756 52.5402 18.534 29 27.3345" stroke="#000" stroke-width="2" />
                        <path d="M80.264 39.8672C78.352 30.3069 55.8853 9.2743 28.7143 19.4322" stroke="#000" stroke-width="2" />
                        <path d="M87.5 32.5C85.3703 21.8515 61.2637 -0.314042 31 11" stroke="#000" stroke-width="2.12969" />
                        <path d="M34 4C20.8333 29.5 29.5 83.5 87 81.5" stroke="#000" stroke-width="2" />
                        <path d="M24.5 8C11.3333 33.5 22 91 79.5 89" stroke="#000" stroke-width="2" />
                        <path d="M15 15.5C1.83333 41 10.2353 97.5 67.7353 95.5" stroke="#000" stroke-width="2" />
                        <path d="M28.5 28C38.8734 46.7697 69.8629 62.0516 92.5 25.5" stroke="#000" stroke-width="2" />
                        <path d="M29.5 39C39.8734 57.7697 73.8629 72.5516 96.5 36" stroke="#000" stroke-width="2" />
                        <path d="M33 51C43.3734 69.7697 76.3629 84.0516 99 47.5" stroke="#000" stroke-width="2" />
                        <path d="M53 74C55.5 75.5 80.0483 92.3006 96.6112 65.5569" stroke="#000" stroke-width="2" />
